...
SHARED_REL_PATHS = [
    ...
    Path("plugins") / "trade" / "agents" / "x_binance_agent.py",
    ...
    Path("plugins") / "trade" / "agents" / "x_perpl_agent.py",
    Path("plugins") / "trade" / "agents" / "x_phemex_agent.py",
    Path("plugins") / "trade" / "agents" / "x_qfex_agent.py",
