...
def _handle_backtest_slash(raw_args: str) -> str:
    """Handler invoked by non-Telegram surfaces for /backtest."""
    return (
        "`/backtest` is a Telegram-only wizard. "
        "Open Hermes on Telegram and type /backtest to start."
    )
