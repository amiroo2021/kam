"""Signed HttpOnly session cookies + login rate limiting for WebBacktest."""
...
from .config import WebBacktestConfig
...
class SessionManager:
    ...
    def __init__(self, config: WebBacktestConfig) -> None:
        self.config = config
